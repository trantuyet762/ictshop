...
namespace Ictshop.Areas.Admin.Controllers
{
        ...
        
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var lpkselected = new SelectList(db.LoaiPhuKiens, "maLinhKien", "tenLinhKien", dt.maLinhKien);
            ViewBag.maLinhKien = lpkselected;
            return View(dt);
        }
        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                oldItem.BaoHanh = sanpham.BaoHanh;
                oldItem.Mahang = sanpham.Mahang;
                oldItem.Mahdh = sanpham.Mahdh;
                oldItem.maLinhKien = sanpham.maLinhKien;
                // lưu lại
                db.SaveChanges();
